...
public class BookingValidateManageLogic {
...
// redirect to another page
    public static void navigateJS(PrintWriter out) {
        ...
        out.println("alert(\"Record has been updated and url will be redirected\")"); out.println("window.location.assign(\"BookingServlet?currentPage=1&recordsPerPage=70&keyword=&direction=ASC\")");
        out.println("</SCRIPT>");
    }
}
