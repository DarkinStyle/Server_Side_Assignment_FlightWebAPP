...
<div class="mainindex">
    <section id="content">
        ...
        <%
            boolean loginFail = (boolean) request.getAttribute("failLogin");
            if (!loginFail)
            {
                out.println("<div class=\"container\" style=\"margin:20px 0 30px 30px;\">\n" +
...
"                                <input required type=\"email\" name=\"email\" class=\"form-control\" id=\"formControlInput2\" placeholder=\"name@example.com\">\n" +
"                            </div>\n" +
"                        </td>\n" +
"                    </tr>\n" +
"                    <tr>\n" +
...
"                                <input required type=\"password\" name=\"password\" class=\"form-control\" id=\"formControlInput3\" placeholder=\"Your Password\">\n" +
"                            </div>\n" +
"                        </td>\n" +
"                    </tr>\n" +
"                </table>\n" +
"                <button type=\"submit\" class=\"btn btn-success\" name=\"\" VALUE=\"\">LOGIN</button>\n" +
                   ...
                   "<tr>\n" +
                      ...
                      "<div class=\"alert alert-danger d-flex align-items-center\" role=\"alert\">" +
                            "<svg class=\"bi flex-shrink-0 me-2\" width=\"24\" height=\"24\" role=\"img\" aria-label=\"Info:\"><use xlink:href=\"#info-fill\"/></svg>" +
                                "<div>" +
                        "You have enter wrong login credentials" +
                                "</div> </div>" +
                            "</td>\n" +
                      "</tr>\n" +
"                    <tr>\n" +
